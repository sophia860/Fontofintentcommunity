...
const S: Record<string, React.CSSProperties> = {
  ...
  h1: { fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: 600, margin: '0 0 1.5rem', lineHeight: 1.1, fontFamily: "'Caveat', cursive" },
  ...
  h2: { fontSize: 'clamp(1.4rem, 2.5vw, 2rem)', fontWeight: 500, marginBottom: '1.5rem', letterSpacing: '0.01em', fontFamily: "'Caveat', cursive" },
  ...
  pathwayTitle: { fontSize: 'clamp(1.5rem, 3vw, 2.25rem)', fontWeight: 500, marginBottom: '1.5rem', lineHeight: 1.2, fontFamily: "'Caveat', cursive" },
    ...
    <div style={S.page}>
      ...
      <section style={S.hero}>
        ...
        <p style={S.body}>
          ...
          <mark className="mark">Quality is compensated.</mark> The institution pays to be associated
          with work it believes in.
        </p>
      </section>
