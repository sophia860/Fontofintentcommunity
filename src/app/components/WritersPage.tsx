...
const S: Record<string, React.CSSProperties> = {
  ...
  writerName: { fontSize: 'clamp(2.2rem, 5vw, 3.5rem)', fontWeight: 600, lineHeight: 1.1, letterSpacing: '-0.01em', margin: '0 0 1.5rem', fontFamily: pickHeadingFont('WritersPage-writerName') },
  ...
  featuredTitle: { fontSize: 'clamp(1.3rem, 2.5vw, 1.8rem)', fontWeight: 500, lineHeight: 1.2, fontStyle: 'italic', color: '#1a1714', marginBottom: '1.5rem', fontFamily: pickHeadingFont('WritersPage-featuredTitle') },
