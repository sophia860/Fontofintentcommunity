...
const S: Record<string, React.CSSProperties> = {
  ...
  writerName: { fontSize: 'clamp(1.8rem, 4vw, 3rem)', fontWeight: 400, lineHeight: 1.1, letterSpacing: '-0.01em', margin: '0 0 1.5rem' },
  ...
  featuredTitle: { fontSize: 'clamp(1.1rem, 2.5vw, 1.5rem)', fontWeight: 400, lineHeight: 1.3, fontStyle: 'italic', color: '#1a1714', marginBottom: '1.5rem' },
